...
export const Chip = styled.div<IChipProps>`
  ...
  &:hover {
    background-color: ${({ theme, onClick }) => onClick ? theme.colors.BLACK_200 : theme.colors.BLACK_100};
  }
  &:active {
    background-color: ${({ theme, onClick }) => onClick ? theme.colors.BLACK_200 : theme.colors.BLACK_100};
    color: ${({ theme, onClick }) => onClick ? theme.colors.CORAL_300 : theme.colors.BLACK_400};
  }
