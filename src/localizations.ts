    ...
    pages: {
      ...
      [PageName.ABOUT]: {
        ...
        text: {
          ...
          subtitle1: 'Команда',
          text1: 'Мы небольшая инхаус команда в которую входят разработчики, дизайнеры и SSM специалисты.',
          subtitle2: 'Обратная связь',
          text2: 'Если у тебя есть вопросы, предложения или вам нужен проект под ключ, напишите нам на suckmydick@gmail.com',
          subtitle3: 'FAQ',
    ...
    pages: {
      ...
      [PageName.ABOUT]: {
        ...
        text: {
          ...
          text2: 'Якщо у тебе є питання, пропозиції або вам потрібен проект під ключ, напишіть нам на suckmydick@gmail.com',
          subtitle3: 'FAQ',
