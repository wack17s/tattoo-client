    ...
    pages: {
      [PageName.MAIN]: {
        ...
        text: {
          ...
          text: "Чтобы найти лучших тату мастеров в своем городе",
          text2: "пройди несколько простых шагов.",
          button: "Начать"
        }
      },
      ...
      [PageName.CHOOSE_STYLE]: {
        ...
        text: {
          ...
          text: "Выбери стилистику в которой ищешь мастера",
          text2: "(можно выбрать несколько вариантов)",
          button: "Все стили",
          chooseButton: "Далее",
        }
      },
    ...
    pages: {
      [PageName.MAIN]: {
        ...
        text: {
          ...
          text: "Щоб знайти кращих тату майстрів в своєму місті",
          text2: "пройди декілька простых кроків.",
          button: "Почати"
        }
      },
      [PageName.CHOOSE_CITY]: {
      ...
      [PageName.CHOOSE_STYLE]: {
        ...
        text: {
          ...
          text: "Обери стилістику в котрій шукаєш майстра",
          text2: "(можно обрати кілька варіантів)",
          button: "Всі стили",
          chooseButton: "Далі",
        }
      },
