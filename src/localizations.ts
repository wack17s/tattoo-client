    ...
    pages: {
      ...
      [PageName.ABOUT]: {
        ...
        text: {
          ...
          text2: 'Если у тебя есть вопросы, предложения или вам нужен проект под ключ, напишите нам на mytattoo17@gmail.com',
          subtitle3: 'FAQ',
    ...
    pages: {
      ...
      [PageName.ABOUT]: {
        ...
        text: {
          ...
          text2: 'Якщо у тебе є питання, пропозиції або вам потрібен проект під ключ, напишіть нам на mytattoo17@gmail.com',
          subtitle3: 'FAQ',
